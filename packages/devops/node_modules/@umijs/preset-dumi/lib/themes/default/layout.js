...
var Layout = /*#__PURE__*/function (_Component) {
  ...
  function Layout() {
    ...
    _this.renderHero = function (hero) {
      ...
      }, /*#__PURE__*/_react.default.createElement("h1", null, hero.title), /*#__PURE__*/_react.default.createElement("p", {
  ...
  _createClass(Layout, [{
    ...
    value: function componentDidMount() {
      ...
      if (/\w\/$/.test(this.props.location.pathname)) {
        _umi.history.replace(this.props.location.pathname.replace(/\/$/, ''));
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var showSideMenu = currentRouteMeta.sidemenu !== false && !showHero && !showFeatures;
      var showSlugs = !showHero && !showFeatures && Boolean((_currentRouteMeta$slu = currentRouteMeta.slugs) === null || _currentRouteMeta$slu === void 0 ? void 0 : _currentRouteMeta$slu.length) && (currentRouteMeta.toc === 'content' || currentRouteMeta.toc === undefined);
      ...
      }, children, !showHero && !showFeatures && /*#__PURE__*/_react.default.createElement("div", {
    ...
    value: function getDerivedStateFromProps(_ref3) {
      ...
      var state = {
        ...
        currentSlug: (0, _isHashRoute.default)() ? location.query.anchor : decodeURIComponent(location.hash).replace('#', ''),
        navs: [],
        menus: []
      ...
      if (navs[state.currentLocale]) {
        for (var _i = navs[state.currentLocale].length - 1; _i >= 0; _i -= 1) {
          ...
          if (new RegExp("^".concat(nav.path.replace(/\.html$/, ''), "(/|.|$)")).test(location.pathname)) {
            navPath = nav.path;
            break;
          }
        }
