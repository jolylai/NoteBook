...
function _rehypePrism() {
  const data = _interopRequireDefault(require("@mapbox/rehype-prism"));

  _rehypePrism = function _rehypePrism() {
    return data;
  };
...
const PLUGIN_STRATEGIES = {
  ...
  }], [_rehypePrism().default], [_previewer.default], [_jsx.default], [_isolation.default]],
