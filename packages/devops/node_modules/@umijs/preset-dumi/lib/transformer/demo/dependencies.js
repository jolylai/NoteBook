...
exports.default = exports.PLAIN_TEXT_EXT = exports.LOCAL_DEP_EXT = void 0;
...
const LOCAL_DEP_EXT = ['.jsx', '.tsx', '.js', '.ts']; // local dependency extensions which will be collected

exports.LOCAL_DEP_EXT = LOCAL_DEP_EXT;
const PLAIN_TEXT_EXT = [...LOCAL_DEP_EXT, '.json', '.less', '.css', '.scss', '.sass', '.styl'];
